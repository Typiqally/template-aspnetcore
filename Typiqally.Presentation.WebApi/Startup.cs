...
namespace Typiqally.Presentation.WebApi
{
	public class Startup
	{
		...
		public void ConfigureServices(IServiceCollection services)
		{
			...
			services.AddAutoMapper(config => { config.AddProfile<WeatherForecastViewModelMappingProfile>(); });
		}
		...
		public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
		{
			if (env.IsDevelopment())
			{
				...
				app.UseSwagger();
				app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Typiqally.Presentation.WebApi v1"));
			}
